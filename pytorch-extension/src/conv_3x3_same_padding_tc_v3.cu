...
__global__ void conv_cuda_tc_forward_kernel_v3(
...
//   int GEMM_K = C * R * S;
  ...
  AT_DISPATCH_FLOATING_TYPES_AND_HALF(torch::kFloat16, "conv_forward_tc_cuda_v3", ([&] {
    conv_cuda_tc_forward_kernel_v3<<<gridDim, blockDim>>>(
